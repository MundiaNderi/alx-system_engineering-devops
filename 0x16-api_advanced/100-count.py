...
def count_words(subreddit, word_list, count=0, after_val=None):
    ...
    Args:
        ...
        word_list (list): A list of keywords to search for in the titles of hot articles.
    ...
    Returns:
        int: The total count of occurrences of the keywords in the titles of hot articles.
    '''
